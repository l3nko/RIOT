...
static rpl_parent_t *which_parent(ng_rpl_parent_t *, ng_rpl_parent_t *);
static rpl_dodag_t *which_dodag(ng_rpl_dodag_t *, ng_rpl_dodag_t *);
...
ng_rpl_dodag_t *which_dodag(ng_rpl_dodag_t *d1, rpl_dodag_t *d2)
{
    (void) d2;
    return d1;
}
